...
public class UnitTest {
    ...
    @Test
    public void testLoopDepthFirst1() {
        DirectedGraph g = new DirectedGraph();
        for (int i = 0; i < 3; i++) {
            g.add();
        }
    ...
    @Test
    public void testLoopDepthFirst2() {
        UndirectedGraph g = new UndirectedGraph();
        for (int i = 0; i < 3; i++) {
            g.add();
        }
    ...
    public void testShortestPaths3() {
        ...
        g.add(3, 6);
        g.add(1, 6);
        TestSimpleShortestPaths ssp2 = new TestSimpleShortestPaths(g, 1);
        ssp2.setPaths();
        assertEquals(ssp2.getWeight(5), 2.0, 0);
        assertEquals(ssp2.getWeight(6), 1.0, 0);
        assertEquals(ssp2.getWeight(3), 2.0, 0);
    }
}
